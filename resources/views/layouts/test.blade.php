...
<html lang="en">
  ...
  <body class="nav-md">
    ...
    <!-- bootstrap-wysiwyg -->
    <script src="{{asset('assets/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js')}}"></script>
    <script src="{{asset('assets/jquery.hotkeys/jquery.hotkeys.js')}}"></script>
    <script src="{{asset('assets/google-code-prettify/src/prettify.js')}}"></script>
